...
> **Przeniesione do specyfikacji:** [2026-07-07-raport-kolekcja.md](2026-07-07-raport-kolekcja.md) —
> trwała kolekcja analiz na `DatasetReport` (wzorzec MDBinom), z jedną korektą
> względem propozycji poniżej: standardowe wykresy wchodzą do kolekcji jako
> **fabryki figur**, nie gotowe `Figure` (statystyki to dane, wykresy to
> renderowanie). Treść poniżej zostawiona jako ślad decyzji.
...
Projekt z [2026-05-31-buck-refaktor-klasy.md](2026-05-31-buck-refaktor-klasy.md) (sekcja 4.5) ujmuje
...
`bckt_stats_over_time`, sekcja 4.4 w [2026-05-31-buck-refaktor-klasy.md](2026-05-31-buck-refaktor-klasy.md))
...
`from_bins` (`bins: list[float]`). Opis: [2026-05-31-buck-refaktor-klasy.md](2026-05-31-buck-refaktor-klasy.md),
...
[2026-05-31-buck-refaktor-klasy.md](2026-05-31-buck-refaktor-klasy.md), sekcja 7 pkt 8). Czystsze
...
Kontrakt typów ([2026-05-31-typy-danych.md](2026-05-31-typy-danych.md), sekcja 3) wymienia `Categorical`
...
[2026-07-04-dataset-fasada.md](2026-07-04-dataset-fasada.md).
